...
<a id="facts"></a>
<!-- facts:begin -->
<!-- Generated by scripts/update-facts-block.sh from repository data.
     Do not edit by hand: check-docs-consistency.sh verifies it against the sources. -->
**Facts as of 2026-09-12.** Installer 5.34.0. OS support dates verified against vendor data on 2026-08-29.
...
Recommended: Ubuntu 24.04 LTS, Ubuntu 26.04, Debian 13. Ubuntu 25.10 and Debian 12 install and run too, but both are past regular support - the dates are in the compatibility table below. Any cheap VPS with 1 GB RAM is enough.
...
* **Broad OS support** - Ubuntu 24.04, 26.04 and Debian 13; Ubuntu 25.10 and Debian 12 for moving an existing server across
...
* **OS:** A **clean** installation of **Ubuntu Server 24.04 LTS** / **Ubuntu 26.04** / **Debian 13** Minimal. Ubuntu 25.10 and Debian 12 are supported too, but do not pick either for a NEW server - see the compatibility table
...
| OS | Our pick | Vendor support | Notes |
|----|----------|----------------|-------|
...
1.  **Connect** to a **clean** server (Ubuntu 24.04 / Ubuntu 26.04 / Debian 13) via SSH.
...
2.  **Download the script:**
    ```bash
    wget -O install_amneziawg_en.sh https://github.com/bivlked/amneziawg-installer/releases/latest/download/install_amneziawg_en.sh
    # or: curl -fLo install_amneziawg_en.sh https://github.com/bivlked/amneziawg-installer/releases/latest/download/install_amneziawg_en.sh
    ```
